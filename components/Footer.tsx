      ...
      <div className="footer-inner" style={{
        ...
        <div style={{ display: "flex", gap: "60px", flexWrap: "wrap" }}>
          <div className="footer-inner" style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <Link href="/popok-artist" onClick={() => analytics.premiumClick("footer")} style={{ textDecoration: "none", fontSize: "0.875rem", color: "var(--ink-muted)", fontWeight: 500 }}>POPOK Artist</Link>
          </div>
          <div className="footer-inner" style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
