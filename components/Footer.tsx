...
export default function Footer() {
  ...
  const language = pathname.startsWith("/en") ? "en" : storedLanguage;
      ...
      <div style={{
        ...
        <div className="footer-bottom-row" style={{
          ...
          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", justifyContent: "center" }}>
            <Link href="/terms" style={{ color: "inherit", textDecoration: "none" }} onMouseOver={(e) => e.currentTarget.style.textDecoration = "underline"} onMouseOut={(e) => e.currentTarget.style.textDecoration = "none"}>{isKo ? "이용약관" : "Terms"}</Link>
            <span style={{ color: "var(--border-dark)" }}>·</span>
            <Link href="/privacy" style={{ color: "inherit", textDecoration: "none", fontWeight: 700 }} onMouseOver={(e) => e.currentTarget.style.textDecoration = "underline"} onMouseOut={(e) => e.currentTarget.style.textDecoration = "none"}>{isKo ? "개인정보처리방침" : "Privacy"}</Link>
            <span style={{ color: "var(--border-dark)" }}>·</span>
            <Link href="/copyright" style={{ color: "inherit", textDecoration: "none" }} onMouseOver={(e) => e.currentTarget.style.textDecoration = "underline"} onMouseOut={(e) => e.currentTarget.style.textDecoration = "none"}>{isKo ? "저작권 및 콘텐츠 정책" : "Copyright & Content"}</Link>
            <span style={{ color: "var(--border-dark)" }}>·</span>
            <a href="mailto:popok.service@gmail.com" aria-label={isKo ? "POPOK 운영팀으로 이메일 문의 보내기" : "Email the POPOK team"} style={{ color: "inherit", textDecoration: "none" }} onMouseOver={(e) => e.currentTarget.style.textDecoration = "underline"} onMouseOut={(e) => e.currentTarget.style.textDecoration = "none"}>{isKo ? "문의하기" : "Contact"}</a>
          </div>
        ...
        <div className="footer-bottom-row" style={{
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", justifyContent: "center" }}>
            ...
            <span>
              E-mail.{" "}
              <a href="mailto:popok.service@gmail.com" aria-label={isKo ? "POPOK 운영팀으로 이메일 문의 보내기" : "Email the POPOK team"} style={{ color: "inherit", textDecoration: "none" }} onMouseOver={(e) => e.currentTarget.style.textDecoration = "underline"} onMouseOut={(e) => e.currentTarget.style.textDecoration = "none"}>
