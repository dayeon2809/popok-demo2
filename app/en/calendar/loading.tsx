export default function EnglishCalendarLoading() {
  return <div aria-label="Loading performance magazine" aria-busy="true" style={{ maxWidth: 1240, margin: "0 auto", padding: "72px 24px 120px" }}>
