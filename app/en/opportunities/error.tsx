...
export default function EnglishOpportunitiesError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return <div role="alert" style={{ maxWidth: 720, margin: "80px auto", padding: "64px 24px", textAlign: "center" }}>
    <h1 style={{ color: "var(--navy)", fontSize: "2rem" }}>We couldn't load the opportunities list.</h1>
