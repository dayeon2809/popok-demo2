...
Piece of Cake는 공연을 고르고, 감상을 나누고, 아티스트와 단체를 발견하는 무용 커뮤니티·아카이브 플랫폼입니다. 흩어져 있는 무용 공연, 아티스트, 작품 정보를 하나의 서비스 안에서 연결하여, 사용자가 다음과 같은 흐름으로 자연스럽게 이동하도록 설계되어 있습니다.
...
Piece of Cake는 단순한 공연 정보 사이트가 아니라, 다음 네 가지 관계를 연결하는 무용 발견 플랫폼을 지향합니다.
