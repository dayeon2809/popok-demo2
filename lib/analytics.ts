...
export const analytics = {
  ...
  opportunityFilterClick: (category: string) => trackEvent("opportunity_filter_click", { category }),
  opportunityCardClick: (opportunityId: string) => trackEvent("opportunity_card_click", { opportunity_id: opportunityId }),
  opportunitySaveClick: (opportunityId: string) => trackEvent("opportunity_save_click", { opportunity_id: opportunityId }),
  opportunityExternalLinkClick: (opportunityId: string) => trackEvent("opportunity_external_link_click", { opportunity_id: opportunityId }),
  opportunityCollaborationConnectClick: (postId: string) => trackEvent("opportunity_collaboration_connect_click", { post_id: postId }),
};
