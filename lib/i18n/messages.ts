...
const messages = {
  ko: {
    nav: { about: "소개", artists: "아티스트", companies: "단체", performances: "공연", faq: "자주 묻는 질문" },
  ...
  en: {
    nav: { about: "About", artists: "Artists", companies: "Companies", performances: "Performances", faq: "FAQ" },
